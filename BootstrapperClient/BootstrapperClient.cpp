...
HRESULT BootstrapperClient::SheduleTaskWinVista()
{
    ...
    CComBSTR description(L"This tasks helps Roblox game be updated.");
    regInfo->put_Description(description);
...
void BootstrapperClient::deployExtraStudioBootstrapper(std::string exeName, const TCHAR *linkName, std::wstring componentId, bool forceDesktopIconCreation, const TCHAR *registryPath)
{
